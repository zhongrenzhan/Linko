...
public class AddIncomeCategoryActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.bt_addcategory_chooseacount:// 选择账户的按钮
			Intent intent = new Intent(AddIncomeCategoryActivity.this,
		...
		case R.id.bt_categorylist_add:// 添加的按钮
			if ("".equals(category) || "请选择账户".equals(account)) {
				Toast.makeText(AddIncomeCategoryActivity.this, "请输完整的信息！",
						Toast.LENGTH_SHORT).show();
			} else {
				SqlOperate operate = new SqlOperate(AddIncomeCategoryActivity.this);
				operate.insertCategory(category, account, remark);
				Toast.makeText(AddIncomeCategoryActivity.this, "恭喜，添加成功！",
						Toast.LENGTH_SHORT).show();
