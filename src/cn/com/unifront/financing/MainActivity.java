...
public class MainActivity extends Activity implements OnItemClickListener,
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        switch (arg2) {
            case 0:
                loadPayIncomeActivity(0);
                break;
            case 1:
                loadPayIncomeActivity(1);
                break;
            case 2:
                loadPayIncomeActivity(2);
                break;
            case 3:
    ...
    private void loadPayIncomeActivity(int what) {
        Intent intent = new Intent(MainActivity.this, PayIncomeActivity.class);
        intent.putExtra("what_launch", what);
