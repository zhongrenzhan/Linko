...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        /* 表6 ：pay_income 收支表 */
        db.execSQL("create table if not exists pay_income(_id integer primary key autoincrement,money text,type text,account text ,time text , remark text ,amount float default 0)");
